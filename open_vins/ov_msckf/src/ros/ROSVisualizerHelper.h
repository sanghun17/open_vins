...
public:
   ...
   */
  static sensor_msgs::PointCloud2 get_ros_pointcloud(const std::vector<Eigen::Vector3d> &feats, const std::string &frame_id);
   ...
   * @return ROS pointcloud
   */
  static sensor_msgs::msg::PointCloud2 get_ros_pointcloud(std::shared_ptr<rclcpp::Node> node, const std::vector<Eigen::Vector3d> &feats, const std::string &frame_id);
