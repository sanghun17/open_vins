...
public:
  ...
  /**
   * @brief Callback for ground truth odometry data
   * @param msg Ground truth odometry message
   */
  void callback_gt_odom(const nav_msgs::Odometry::ConstPtr &msg);
...
protected:
  ...
  ros::Publisher pub_poseimu, pub_poseimu_with_covariance, pub_odomimu, pub_poseimu_stamped, pub_pathimu;
  ...
  // Frame parameters
  std::string frame_id = "global";
  std::string child_frame_id = "imu";
};
